...
var blackIcon = new L.Icon({
  ...
  //shadowSize: [41, 41]
    ...
    // const marker = L.marker([ weather.lat,  weather.lon]).addTo(mymap);
    let txt = ` City: &nbsp&nbsp&nbsp${ weather.city_name} <br>
                AQI: &nbsp&nbsp&nbsp${ weather.data[0].aqi}  <br>
                O3:  &nbsp&nbsp&nbsp&nbsp&nbsp${ weather.data[0].o3} <br>
                SO2: &nbsp&nbsp${ weather.data[0].so2} <br>
                NO2: &nbsp&nbsp${ weather.data[0].no2} <br>
